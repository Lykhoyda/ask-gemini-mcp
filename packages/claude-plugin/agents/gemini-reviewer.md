...
When calling `ask-gemini`, structure your prompt to request confidence scoring:
...
Parse Gemini's response and return a structured summary:
...
- If Gemini finds no high-confidence issues, say so clearly. Do not invent problems.
